...
ActiveRecord::Schema[8.1].define(version: 2025_12_11_192410) do
  ...
  create_table "turma_users", force: :cascade do |t|
    ...
    t.datetime "updated_at", null: false
    t.bigint "user_id", null: false
    t.index ["turma_id"], name: "index_turma_users_on_turma_id"
    t.index ["user_id", "turma_id"], name: "index_turma_users_on_user_id_and_turma_id", unique: true
    t.index ["user_id"], name: "index_turma_users_on_user_id"
  end
  ...
  add_foreign_key "turma_users", "turmas"
  add_foreign_key "turma_users", "users"
end
