...
Feature: Gerenciamento de turmas por departamento
  ...
  Scenario: Listar apenas turmas do departamento do administrador
  ...
  Scenario: Gerenciar turma do próprio departamento
  ...
  Scenario: Tentativa de acesso a turma de outro departamento
