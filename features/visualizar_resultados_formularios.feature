# Visualização de formulários criados
@issue-110
Feature: Visualização de Formulários para Geração de Relatório
  Como administrador
  ...
  Scenario: Visualizar e filtrar formulários criados
  ...
  Scenario: Acesso à geração de relatório
  ...
  Scenario: Formulário sem respostas
