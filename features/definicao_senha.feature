@issue-105
Feature: Definição de senha de acesso
  Como usuário
  ...
  Scenario: Tentativa de definição de senha com token inválido ou expirado
  ...
  Scenario: Tentativa de definição de senha com confirmação divergente
    Quando o usuário informa a nova senha "NovaSenhaValida123"
  ...
  Scenario: Tentativa de definição de senha que não atende aos requisitos mínimos
