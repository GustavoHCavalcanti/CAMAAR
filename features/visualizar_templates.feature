...
@issue-111
Feature: Visualizar e Gerenciar Templates
  Como administrador
  ...
  Scenario: Listar templates criados pelo próprio administrador
  ...
  Scenario: Acesso a tela de edição
  ...
  Scenario: Administrador sem templates criados
