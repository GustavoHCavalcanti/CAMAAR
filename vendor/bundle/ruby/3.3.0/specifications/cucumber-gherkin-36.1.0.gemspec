# -*- encoding: utf-8 -*-
# stub: cucumber-gherkin 36.1.0 ruby lib

Gem::Specification.new do |s|
  s.name = "cucumber-gherkin".freeze
  s.version = "36.1.0".freeze
  ...
  s.summary = "cucumber-gherkin-36.1.0".freeze

  s.installed_by_version = "3.7.2".freeze

  s.specification_version = 4

  s.add_runtime_dependency(%q<cucumber-messages>.freeze, ["> 25".freeze, "< 30".freeze])
