# -*- encoding: utf-8 -*-
# stub: cucumber-core 15.4.0 ruby lib
...
Gem::Specification.new do |s|
  ...
  s.summary = "cucumber-core-15.4.0".freeze

  s.installed_by_version = "3.7.2".freeze

  s.specification_version = 4

  s.add_runtime_dependency(%q<cucumber-gherkin>.freeze, ["> 27".freeze, "< 40".freeze])
  s.add_runtime_dependency(%q<cucumber-messages>.freeze, ["> 26".freeze, "< 33".freeze])
